    ...
    <div>
      ...
      <main className="mobile mt-6 sm:mt-12 md:mt-16 flex flex-col text-white pl-12 md:pl-20">
        ...
        <section className="selfbio mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl">
          ...
          <br /><br />
          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Currently reading</span>: <span style={{fontStyle: 'italic'}}>Argonauts</span> by Maggie Nelson (also recommend reading her Bluets) & <span style={{fontStyle: 'italic'}}>Godel, Escher, Bach</span> by Hofstadter. Also, check out my <a style={{textDecoration: "dotted underline", fontStyle: 'italic'}} href="https://invisible-cities.vercel.app/">Invisible Cities</a> site.</span>
          <br /><br />
          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Current listening</span>: <a style={{textDecoration: "dotted underline", "textDecorationStyle": 'dotted', fontStyle: 'italic'}} href="https://open.spotify.com/album/3gF9KIynrJaC80HbVayPMx?si=KBXUac8VREuHu01AzrYJqw">Unreal Unearth</a> by Hozier & <a style={{fontStyle: 'italic'}} href="https://open.spotify.com/artist/2eam0iDomRHGBypaDQLwWI?si=jzkiW3-XToqaC0pucylJEQ">Bleachers</a> by Bleachers. (Also, my current playlist on loop: <a style={{textDecoration: "underline", "textDecorationStyle": 'dotted', fontStyle: 'italic'}} href="https://open.spotify.com/playlist/0ougicLNjGgbmIIsvp4Z1L?si=7170355da302401f">dahhling</a>.) More recs for books and music can be found <a style={{textDecoration: "underline", "textDecorationStyle": 'dotted', fontStyle: 'italic'}} href="https://www.clairebookworm.com/notes/recs">here</a>.</span>
        </section>
