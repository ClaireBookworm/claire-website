    ...
    <div>
      ...
      <main className="mobile mt-6 sm:mt-12 md:mt-16 flex flex-col text-white pl-12 md:pl-20">
        ...
        <section className="selfbio mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl">
          ...
          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Recently</span>: <span style={{fontStyle: 'italic'}}>I've just taken a gap semester from MIT in SF working towards building a whole brain connectome of the mouse brain at <a className="landing-link" href="https://e11.bio">e11.bio</a>! ♥︎ </span></span>
          <br /><br />
