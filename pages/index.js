    ...
    <div>
      ...
      <main className="mobile mt-6 sm:mt-12 md:mt-16 flex flex-col text-white pl-12 md:pl-20">
        ...
        <section className="selfbio mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl">
          ...
          If you ever see me, I'll probably either be talking about <a className="landing-link" href="https://hackclub.com/">Hack Club</a>, expressing my undying love for Bleachers & my Spotify <a className="landing-link" href="https://open.spotify.com/user/rsjahryaqu08yocko5k5cfd9s?si=5952a9845b984880">playlists</a>, ranting about <a className="landing-link" href="https://bookshelf.website/clairebookworm">books</a>, stuck in the <a className="landing-link" href="https://jasanofflab.mit.edu/">lab</a> where I'm currently researching <a className="landing-link" href="https://synthneuro.org/">whole brain simulation</a> of C. elegans and connectomics, or writing bad music <a className="landing-link" href="https://musicboard.app/clairebookworm">reviews</a> on my <a className="landing-link" href="https://clairebookworm.substack.com">blog</a>. I truly believe in the art of making for the betterment of the world while having fun doing so. DFTBA¹!
          <br /><br />

          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Recently</span>: <span style={{fontStyle: 'italic'}}>I've just taken a gap semester from MIT in SF working towards building a whole brain connectome of the mouse brain at <a className="landing-link" href="https://e11.bio">e11.bio</a>! ♥︎ I'm also spending IAP 2026 doing engineer at <a className="landing-link" href="https://github.com/dimensionalOS">DimensionalOS</a>, a startup building a fully open-source universal robotics framework. </span></span>
          <br /><br />

          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Now</span>: <span style={{fontStyle: 'italic'}}>I'm taking <a className="landing-link" href="https://fab.cba.mit.edu/classes/MAS.863/">How to Make (almost) Anything</a>, and you can find my project and work updates <a className="landing-link" href="https://fab.cba.mit.edu/classes/863.25/people/ClaireWang/">here</a>!</span></span>
          
          <br /><br />
          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Currently reading</span>: <span style={{fontStyle: 'italic'}}>Argonauts</span> by Maggie Nelson (also recommend reading her Bluets) & <span style={{fontStyle: 'italic'}}>Godel, Escher, Bach</span> by Hofstadter. Also, check out my <a className="landing-link" style={{fontStyle: 'italic'}} href="https://invisible-cities.vercel.app/">Invisible Cities</a> site.</span>
          <br /><br />
          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Current listening</span>: <a className="landing-link" style={{fontStyle: 'italic'}} href="https://open.spotify.com/album/3n0N3fSeIXDhMWSFtN2rX9?si=IOA6NIxMSMutxkC7Fjk60w">purity ring</a> & <a className="landing-link" style={{fontStyle: 'italic'}} href="https://open.spotify.com/artist/2eam0iDomRHGBypaDQLwWI?si=jzkiW3-XToqaC0pucylJEQ">Bleachers</a>. I run a weekly radio show Monday nights (12-1AM EST), <a className="landing-link" style={{ fontWeight: '600'}} href="https://wmbr.org/cgi-bin/show?id=9072">Death Car for QT</a>, listenable at 88.1 FM in Boston or at <a className="landing-link" style={{fontStyle: 'italic'}} href="https://wmbr.org/">wmbr.org</a>, and my personal tracklist and descriptions at <a className="landing-link" style={{fontStyle: 'italic'}} href="https://www.clairebookworm.com/radio">here</a>.</span>

          <br /><br />

          <span style={{fontSize: '0.9em', lineHeight: '0.7rem'}}> More recs for books and music can be found <a className="landing-link" style={{fontStyle: 'italic'}} href="https://www.clairebookworm.com/notes/recs">here</a>! </span>
        </section>
