    ...
    <Layout active="Gallery">
      ...
      <div className="mt-12 mr-16 grid gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        ...
        <GalleryCard
          ...
          children="Work on creating an efficient algorithm for bi-core decomposition of graphs. We achieved a higher speedup and an improvement of theoretical work and span based on previous work. This won the S.T.-Yau Globl Science Award and Best CS Project. You can find the github [here](https://github.com/ClaireBookworm/gbbs) or click for the paper."
