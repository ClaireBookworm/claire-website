	...
	return (
		<Layout>
			...
			<main>
				...
				<section className="selfbio mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl" style={{lineHeight: '1.2rem'}}>
					...
					<p style={{paddingTop: '5px'}}><a className="landing-link" href="https://track-blaster.com/wmbr/playlist.php?id=58050">link to recording + track blaster list</a></p>
