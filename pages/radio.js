			...
			<main>
				...
				<section className="selfbio mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl">
					<span style={{marginBottom: "1rem", display: "block"}}>
						<p>Welcome to the radio page!! <a className="landing-link" href="https://www.track-blaster.com/wmbr/index.php?program=587">Death Car for QT</a> (links to live track-blaster playlists) was inspired by really good production and how many shared sampling and styles there are between genres and artists. I'm a huge fan of Jack Antonoff and I think, in general, there's a lot of skill to pop music that's ignored. Beyond that, I really love jazz, electronic music, r&b, alternative indie, punk/psychdelic rock... and want to play them! <br /><br />Every week, I'll have a "connections" with three songs that have something in common. You can also find the tracklist from my <a className="landing-link" href="https://track-blaster.com/wmbr/?startdt=1984-06-28&enddt=2030-09-23&sort=desc&program=587">WMBR track-blaster</a>.</p>
					</span>
