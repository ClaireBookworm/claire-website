...
export function TerminalGlyph() {
  return (
    <div style={{ width: 60, height: 48, margin: '0 auto', background: '#0a0a14', border: '2px solid #0d1b2a', borderTop: '4px solid #5ce6b5', boxShadow: '3px 3px 0 rgba(0,0,0,.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <span style={{ fontFamily: "'VT323',monospace", fontSize: 18, color: '#5ce6b5' }}>~%<span style={{ animation: 'ccBlink 1s step-end infinite' }}>█</span></span>
    </div>
  );
}
...
export function RecsGlyph() {
  return (
    <div style={{ width: 62, height: 48, margin: '0 auto', background: 'linear-gradient(#f3efe4,#e6dfcd)', border: '2px solid #0d1b2a', boxShadow: '3px 3px 0 rgba(0,0,0,.3)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', gap: 3, padding: '0 6px 5px', overflow: 'hidden' }}>
      <div style={{ width: 8, height: 30, background: '#ff5d8f', border: '1.5px solid #0d1b2a' }} />
      <div style={{ width: 7, height: 26, background: '#ffd23f', border: '1.5px solid #0d1b2a' }} />
      <div style={{ width: 6, height: 32, background: '#0c63ff', border: '1.5px solid #0d1b2a' }} />
      {/* record peeking */}
      <div style={{ width: 20, height: 20, borderRadius: '50%', background: 'radial-gradient(circle,#ff8ad1 0 22%,#15130f 23% 100%)', border: '1.5px solid #0d1b2a', marginLeft: 1 }} />
      {/* VHS */}
      <div style={{ width: 12, height: 34, background: '#17131f', border: '1.5px solid #0d1b2a', display: 'flex', justifyContent: 'center', paddingTop: 4 }}>
        <span style={{ width: 7, height: 12, background: '#5ce6b5', border: '1px solid #0d1b2a' }} />
      </div>
    </div>
  );
}
