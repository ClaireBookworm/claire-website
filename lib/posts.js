...
// Lightweight sidebar list for the ClaireOS reader: id, title, date + a
// reading-time estimate. Reads files at build time but ships only metadata
// (no rendered HTML), keeping page payloads small.
